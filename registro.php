...
<body>
    <div class="login">
        ...
        <div class="my-4 text-center lead" id="titulo">Registrarse</div>
        <div class="form-group">
            <form action="login.php" method="POST" id="form">
                ...
                <div class="input-group ml-3 mb-4">
                    <input type="text" name="userPassword" class="form-control" placeholder="Contraseña" />
                    <div class="input-group-append mr-4">
                        <div class="input-group-text bg-white"><i class="fas fa-lock"></i></div>
                    </div>
                </div>
                <div class="input-group ml-3 mb-4">
                    <input type="text" name="userPassword2" class="form-control" placeholder="Repite Contraseña" />
                    <div class="input-group-append mr-4">
                        <div class="input-group-text bg-white"><i class="fas fa-lock"></i></div>
                    </div>
                </div>
                ...
                <div style="margin-top:35px;">
                    <input type="submit" class="btn btn-primary float-left ml-3" style="width:90%" value="Registrarse" />

                    <a href="login.php" class="btn btn-primary float-left ml-3 mt-3 text-white" style="width:90%">Iniciar Sesion</a>

                    <button type="button" style="background-color:white; margin:0; padding:0;color:#007BFF; border:none;outline:none;cursor:pointer" class="mb-5 mt-3 ml-3" onclick="contra()">He olvidado mi contraseña</button>
                </div>
