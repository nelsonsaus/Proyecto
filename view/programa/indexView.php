        ...
        <div id="tablacontenedor" class="table-responsive text-center rounded shadow-lg" style="background-color: #fafafa; width:80%; margin:auto; margin-bottom:80px; margin-top:70px;" class="shadow-lg">
            ...
            <table class="table">
                <div style="height:70px; width:100%; background-color:#360910;" class="text-center">
                    <h4 style="color:white; font-style:italic; padding:15px;">TABLA PROGRAMAS</h4>
                </div>
                <thead style="padding:0;height:40px; width:100%;">
                    ...
                    <th scope="col" style="padding-bottom:25px; border-right:1px solid gray;">categoria</th>
                ...
                <tbody style="background-color: rgba(235,235,235, 0.5); margin-top:0px;">
                    <?php 
						...
						foreach($allprograms as $program) {  ?>
                            <tr>
                                <th scope="row"><?php echo ($program->id); ?></th>
                                <td><?php echo ($program->nombre); ?></td>
                                <td><?php echo $program->categoria; ?></td>
                                <td>
                                    <a class="btn btn-success" href="<?php echo $helper->url("programa","editar"); ?>&id=<?php echo $program->id; ?>"  class="btn btn-editar btn-xs">
                                        <i class="fas fa-pencil-alt">Editar</i>
                                    </a>
                                    <button type="button" class="btn btn-danger" data-toggle="modal" data-href="<?php echo $helper->url("programa","borrar"); ?>&id=<?php echo $program->id; ?>" data-target="#borrar-confirm" ><i class="fas fa-trash"></i>Borrar</button>
        ...
        <div class="col-lg-5 col-md-5 col-sm-12 shadow-lg" style="height:400px; background-color:#fafafa; margin:auto; margin-top:40px; margin-bottom:100px; border-radius:17px;">
            <div>
                <div style="background-color:#360910;width:100%; height:70px;padding-top:15px;">
                              ...
                              <h3 style="color:white; text-align:center;">Editar Programa</h3>
                              <?php }  else if ($operacion == "nuevo") {
                                 $texto_submit="Grabar";?>
                              <h3 style="color:white; text-align:center;">Nuevo Programa</h3>
                              <?php } ?>
                           </div>
                           <div>
                              ...
                              <form id="formulario" action="<?php echo $helper->url("programa","crear"); ?>&volvercontroller=<?php echo $volver["controller"] ?>&volveraction=<?php echo $volver["action"] ?>" method="post" class="form-horizontal" role="form">
                                 ...
                                 <div class="card-body">
                                    ...
                                    <div class="form-group">
                                       <label for="categoria" class="col-sm-3 control-label" style="font-weight:bold; font-size:17px;">Categoria</label>
                                       <div class="col-sm-7" style="margin:auto;">
                                 ...
                                 <?php } ?>
                                    ...
                                    <a href="<?php echo $helper->url("programa","index"); ?>" class="btn btn-primary">Volver</a>
                                    <?php } ?>
                                 </div>
                           </div>
                           </form>
